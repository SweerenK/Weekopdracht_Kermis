...
public class Kassa {
	...
	Double omzetBotsautoGeind, omzetSpinGeind, omzetSpiegelpaleisGeind, omzetSpookhuisGeind, omzetHawaiiGeind,
			omzetLadderklimmenGeind;
	Double[][] omzetAttracties = { { omzetBotsauto = 0.00, omzetBotsautoGeind = 0.00 },
